...
title: |
  ...
  | 2 out of 9 items missing for 10 percent of the units
...
We randomly drop 2 out of 9 items in 10% of the farms.
...
fit1 <- brm( 
  ...
  warmup = 500,
  refresh = 0,
  file = "../results/97-cs-2013-incomplete-2-10.rds"
)
toc()
```
...
write.csv(df.re, file = "../results/97-asi-missing-2-10.csv")
```
...
d.incomplete <- read.csv("../results/97-asi-missing-2-10.csv")
