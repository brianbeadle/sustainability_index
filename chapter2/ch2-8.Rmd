...
title: |
  ...
  | 1 out of 9 items missing for 50 percent of the units
...
We randomly drop 1 out of 9 items in 50% of the farms.

```{r}
# select 50% of the farms
set.seed(134679)
...
fit1 <- brm( 
  ...
  warmup = 500,
  refresh = 0,
  file = "../results/96-cs-2013-incomplete-1-50.rds"
)
toc()
```
...
write.csv(df.re, file = "../results/96-asi-missing-1-50.csv")
```

# Compare with AS score estimated from complete data

TODO move comparison to a new file
...
d.incomplete <- read.csv("../results/96-asi-missing-1-50.csv")
