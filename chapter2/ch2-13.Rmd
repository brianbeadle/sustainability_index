...
title: |
  ...
  | 3 out of 9 items missing for 30 percent of the units
...
We randomly drop 3 out of 9 items in 30% of the farms.
...
fit1 <- brm( 
  ...
  warmup = 500,
  refresh = 0,
  file = "../results/101-cs-2013-incomplete-3-30.rds"
)
toc()
```
...
write.csv(df.re, file = "../results/101-asi-missing-3-30.csv")
```
...
d.incomplete <- read.csv("../results/101-asi-missing-3-30.csv")
