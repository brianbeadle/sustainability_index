...
title: |
  ...
  | 1 out of 9 items missing for 30 percent of the units
...
We randomly drop 1 out of 9 items in 30% of the farms.
...
fit1 <- brm( 
  ...
  warmup = 500,
  # refresh = 0,
  file = "../results/95-cs-2013-incomplete-1-30.rds"
)
toc()
```
...
write.csv(df.re, file = "../results/95-asi-missing-1-30.csv")
```
...
d.incomplete <- read.csv("../results/95-asi-missing-1-30.csv")
