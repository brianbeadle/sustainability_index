...
title: |
  ...
  | 2 out of 9 items missing for 50 percent of the units
...
We randomly drop 2 out of 9 items in 50% of the farms.
...
fit1 <- brm( 
  ...
  warmup = 500,
  refresh = 0,
  file = "../results/99-cs-2013-incomplete-2-50.rds"
)
toc()
```
...
write.csv(df.re, file = "../results/99-asi-missing-2-50.csv")
```
...
d.incomplete <- read.csv("../results/99-asi-missing-2-50.csv")
