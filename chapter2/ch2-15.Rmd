...
fit1 <- brm( 
  ...
  warmup = 500,
  refresh = 0,
  file = paste0("../../results/30-scale-linking/31-corr/east-", 
...
write.csv(df.re, file = paste0("../../results/30-scale-linking/31-corr/east-", 
                                east.item, "-west-", west.item, ".csv"))
```
...
d.incomplete <- read.csv(paste0("../../results/30-scale-linking/31-corr/east-", 
                                east.item, "-west-", west.item, ".csv"))
...
```
```{r}
cor(d.combine$asi.x, d.combine$asi.y, use = "everything")
```
